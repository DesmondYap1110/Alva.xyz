...
<head>
    <meta charset="utf-8">
    <title>Sub Admin Module | Add Sub Admin | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Add Sub Admin</span>
                </div>
            </section>
                            ...
                            <div class="col-lg-8">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Add Sub Admin</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="s_name" name="s_name" maxlength="50" required value="">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div id="table-div">
                                                    ...
                                                    <!-- END OF SUB ADMIN PRIVELEGE TABLE -->
                                                </div>
