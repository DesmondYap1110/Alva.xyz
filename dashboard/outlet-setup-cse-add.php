 <?php
    ...
    if(isset($_POST['add']) && $_POST['add']=="add_form")
    {
        ...
        (
            ...
            'password' => $cse->setPassword("aA12345678"),
            'created_date' => date("Y-m-d H:i:s"),
            'type' => $type
        );


        if( $cse->verifydata("member_ID" , $input['member_ID'])==1 or 
        $cse->verifydata("email" , $input['email'])==1)
        {
            echo "<script>window.location.href='outlet-setup-cse-add.php?process=invalid';</script>";
            exit;
        }

        $cse->adddata("outlet-setup-cse.php",$input);
...
<head>
    <meta charset="utf-8">
    <title>Outlet Setup | CSE Module | Add Staff | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Add Staff</span>
                </div>
            </section>
                            ...
                            <div class="col-lg-8">
                                <div id="form-box" class="general-box">
                                    <form name="add_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Add Staff</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div id="form-btn-div">
                                                    ...
                                                    <button type="submit" id="general-btn" class="btn1 idbtn"><i class="ri-save-3-fill"></i>Save Changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
