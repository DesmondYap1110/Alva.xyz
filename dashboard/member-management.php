...
<head>
    <meta charset="utf-8">
    <title>Member Management | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
            ...
            <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-active">Member Management</span>
                </div>
            </section>
                ...
                <section id="general-section">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="add-btn-div">
                                    <a href="<?php echo $base_url_dashboard; ?>/member-management-add.php" id="general-btn" class="btn1"><i class="ri-add-fill"></i>Add Member</a>
                                </div>
                                <div id="tb-box" class="general-box">
                                    <div id="tb-border-line">
                                        <div id="tb-title-div">
                                            <p id="tb-title">Member Management</p>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div id="tb-act-btn-div">
                                                                <a href="<?php echo $base_url_dashboard; ?>/member-management-edit.php" class="tb-ac-btn" id="tb-ac-btn-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit Member" ><i class="ri-edit-2-line"></i></a>
