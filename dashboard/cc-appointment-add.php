...
<head>
    <meta charset="utf-8">
    <title>Call Center | New Customer Appointment | Add New Customer Appointment | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Add New Customer Appointment</span>
                </div>
            </section>
                            ...
                            <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Add New Customer Appointment</p>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" class="form-control" id="date" name="date" maxlength="50" required value="<?php echo date("Y-m-d")?>">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Key in Time</label>
                                                    <input type="time" class="form-control" id="time" name="time" maxlength="50" required value="<?php echo date('h:i a') ?>">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Key In By</label>
                                                    <input type="text" class="form-control" id="key_in" name="key_in" maxlength="50" required value="">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control js-example-basic-single" id="appointment_time" name="appointment_time" required>
                                                        ...
                                                        <option value="1" >09:00 AM (0)</option>
