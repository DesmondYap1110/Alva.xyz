 <?php
    ...
    //Create Object for Outlet Manager
    //Import from require_once('../php/class/member.class.php');
    $omm = new member("member",$ALVADB);
    ...
    if(isset($_GET['mid']) && $_GET['mid']!=NULL && $_GET['mid']!="")
    {
        ...
        $url= "outlet-setup-manager-edit.php?mid=$member_ID&edit=succ";

        //Link for Password Edit Fail
        $urlfail= "outlet-setup-manager-edit.php?mid=$member_ID&edit=fail";

        //If the URL Parameter is NOT valid Force them OUT
        //Else display THE DATA BASED ON THE URL Parameter
        $row=isvalidParameter($omm, $member_ID, $type);


        //PART TO EDIT MEMBER INFO
        editmemberInfo($member_ID, $omm, $ALVADB);
    }
    else
    {
        echo "<script>window.location.href='outlet-setup-manager.php?process=invalid';</script>";
        exit;
    }
...
<head>
    <meta charset="utf-8">
    <title>Outlet Setup | Outlet Manager Module | Edit Outlet Manager | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    Outlet Setup
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>                    
                    <a href="<?php echo $base_url_dashboard; ?>/outlet-setup-manager">Outlet Manager Module</a>
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Edit Outlet Manager</span>
                </div>
            </section>
                            ...
                            <div class="col-lg-8">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Edit Outlet Manager</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="contact" name="contact" maxlength="50" required value="<?php echo $row['contact']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-xl-8 col-lg-7 col-md-8 col-sm-12 col-12">
                                                <div class="input-group">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    <label>Address</label>
                                                    <input type="text" class="form-control" id="address" name="address" maxlength="50" disabled value="<?php echo displaylocation($outlet,$row['outlet_ID']);?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div id="form-btn-div">
                                                    <a href="<?php echo $base_url_dashboard; ?>/outlet-setup-manager.php" id="general-btn" class="btn2"><i class="ri-close-fill"></i>Cancel</a>
...
function editmemberInfo($ID,$object,$dbconn)
{
    ...
    if(isset($_POST['edit']) && $_POST['edit']=="edit_form")
    {
        ...
        echo "<script>window.location.href='outlet-setup-manager-edit.php?mid=$member_ID&infoedit=succ';</script>";
        exit;
    }
}
...
function checkexist($object,$ID1,$ID2,$email)
{
    ...
    if($ID1!=$ID2)
    {
        ...
        if($check==1)
        {
            echo "<script>window.location.href='outlet-setup-manager-edit.php?mid=$ID1&process=invalid';</script>";
            exit;
        }
