 <?php
    ...
    //The staff in CSE Module : type 1
    $type = 1;
    ...
    if(isset($_GET['mid']) && $_GET['mid']!=NULL && $_GET['mid']!="")
    {
        ...
        $url= "outlet-setup-cse-edit.php?mid=$member_ID&edit=succ";

        //Link for Password Edit Fail
        $urlfail= "outlet-setup-cse-edit.php?mid=$member_ID&edit=fail";

        //If the URL Parameter is NOT valid Force them OUT
        //Else display THE DATA BASED ON THE URL Parameter
        $row=isvalidParameter($cse, $member_ID, $type);


        //PART TO EDIT MEMBER INFO
        editmemberInfo($member_ID, $cse, $ALVADB);
    }
    else
    {
        echo "<script>window.location.href='outlet-setup-cse.php?process=invalid';</script>";
        exit;
    }
...
<head>
    <meta charset="utf-8">
    <title>Outlet Setup | CSE Module | Edit Staff | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    Outlet Setup
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>                    
                    <a href="<?php echo $base_url_dashboard; ?>/outlet-setup-cse.php">CSE Module</a>
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Edit Staff</span>
                </div>
            </section>
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Edit Staff</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div id="form-btn-div">
                                                    <a href="<?php echo $base_url_dashboard; ?>/outlet-setup-cse.php" id="general-btn" class="btn2"><i class="ri-close-fill"></i>Cancel</a>
...
function editmemberInfo($ID,$object,$dbconn)
{
    ...
    if(isset($_POST['edit']) && $_POST['edit']=="edit_form")
    {
        ...
        echo "<script>window.location.href='outlet-setup-cse-edit.php?mid=$member_ID&infoedit=succ';</script>";
        exit;
    }
}
...
function checkexist($object,$ID1,$ID2,$email)
{
    ...
    if($ID1!=$ID2)
    {
        ...
        if($check==1)
        {
            echo "<script>window.location.href='outlet-setup-cse-edit.php?mid=$ID1&process=invalid';</script>";
            exit;
        }
