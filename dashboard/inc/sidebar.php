    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a <?php if ($pg == "mm") { ?>id="sb-active"<?php } ?> class="nav-link menu-link sb-menu-d" href="<?php echo $base_url_dashboard; ?>/member-management.php">
                        <i class="ri-user-line"></i><span>Member Management</span>
                    </a>
                </li>
