...
<head>
    <meta charset="utf-8">
    <title>Outlet Setup | Cashier Module | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
            ...
            <section id="bc-section">
                <div id="bc-div">
                    ...
                    Outlet Setup
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>                    
                    <span id="bc-active">Cashier Module</span>
                </div>
            </section>
                ...
                <section id="general-section">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="add-btn-div">
                                    <a href="<?php echo $base_url_dashboard; ?>/outlet-setup-cashier-add.php" id="general-btn" class="btn1"><i class="ri-add-fill"></i>Add Cashier</a>
                                </div>
                                <div id="tb-box" class="general-box">
                                    <div id="tb-border-line">
                                        <div id="tb-title-div">
                                            <p id="tb-title">Cashier Module</p>
                                            <?php if (isset($_GET['add'])) { $register = $_GET['add']; if ($register == 'succ') { ?>
                                            <div class="alert alert-success" role="alert">
                                                <p class="alert-heading">Cashier Added Successfully.</p>
                                            </div>
                                            <?php } } ?>
                                            <?php if (isset($_GET['delete'])) { $register = $_GET['delete']; if ($register == 'succ') { ?>
                                            <div class="alert alert-success" role="alert">
                                                <p class="alert-heading">Cashier Deleted Successfully.</p>
                                            </div>
                                            <?php } } ?>
                                            <?php if (isset($_GET['update'])) { $register = $_GET['update']; if ($register == 'succ') { ?>
                                            <div class="alert alert-success" role="alert">
                                                <p class="alert-heading">Cashier Edited Successfully.</p>
                                            </div>
                                            <?php } } ?>
                                    ...
                                    <div id="table-padding">
                                        <div id="table-div">
                                            <table id="example" class="table-cse table table-bordered nowrap table-striped align-middle">
                                                ...
                                                <?php
                                                //Display the data
                                                displaydata($cashier,$delete,$ALVADB);
                                                ?>
...
{
    $total_row = $data->totaldata(" AND type='4'");
