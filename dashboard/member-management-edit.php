...
<head>
    <meta charset="utf-8">
    <title>Member Management | Edit Member Profile | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
            ...
            <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Edit Member Profile</span>
                </div>
            </section>
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Edit Member Profile</p>
