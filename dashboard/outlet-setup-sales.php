 <?php
    ...
    $delete = new Modal(
        ...
        //Title Modal
        "Delete Sales Advisor",

        //Modal Description
        "delete this Sales Advisor?",
...
<head>
    <meta charset="utf-8">
    <title>Outlet Setup | Sales Advisor Module | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
            ...
            <section id="bc-section">
                <div id="bc-div">
                    ...
                    Outlet Setup
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>                    
                    <span id="bc-active">Sales Advisor Module</span>
                </div>
            </section>
                ...
                <section id="general-section">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="add-btn-div">
                                    <a href="<?php echo $base_url_dashboard; ?>/outlet-setup-sales-add.php" id="general-btn" class="btn1"><i class="ri-add-fill"></i>Add Sales Advisor</a>
                                </div>
                                <div id="tb-box" class="general-box">
                                    <div id="tb-border-line">
                                        <div id="tb-title-div">
                                            <p id="tb-title">Sales Advisor Module</p>
                                            <?php if (isset($_GET['add'])) { $register = $_GET['add']; if ($register == 'succ') { ?>
                                            <div class="alert alert-success" role="alert">
                                                <p class="alert-heading">Sales Advisor Added Successfully.</p>
                                            </div>
                                            <?php } } ?>
                                            <?php if (isset($_GET['delete'])) { $register = $_GET['delete']; if ($register == 'succ') { ?>
                                            <div class="alert alert-success" role="alert">
                                                <p class="alert-heading">Sales Advisor Deleted Successfully.</p>
                                            </div>
                                            <?php } } ?>
                                            <?php if (isset($_GET['update'])) { $register = $_GET['update']; if ($register == 'succ') { ?>
                                            <div class="alert alert-success" role="alert">
                                                <p class="alert-heading">Sales Advisor Edited Successfully.</p>
                                            </div>
                                            <?php } } ?>
...
{
    $total_row = $data->totaldata(" AND type='3'");
    ...
    if($total_row>0)
    {
        ...
        for($i=0; $i<$total_row; $i++)
        {
            ...
            <tr>
                ...
                <td>'.getLeaderName($data->get_row()[$i]['leader_ID'],$dbconn).'</td>
                ...
                <td>
                    <div id="tb-act-btn-div">
                        <a href="'.$GLOBALS['base_url_dashboard'].'/outlet-setup-sales-edit.php?mid='.$data->get_row()[$i]['ID'].'" class="tb-ac-btn" id="tb-ac-btn-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit Sales Advisor" ><i class="ri-edit-2-line"></i></a>
...
function getLeaderName($ID,$dbconn)
{
    if($ID!="")
    {
