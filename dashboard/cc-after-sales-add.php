 <?php
    ...
    // TO SET CURRENT DATE TIME TO MALAYSIA TIMEZONE
...
<head>
    <meta charset="utf-8">
    <title>Call Center | After Sales Enquiry | Add After Sales Enquiry | <?php echo $base_name; ?></title>
...
<body class="body-d">
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Add After Sales Enquiry</span>
                </div>
            </section>
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Add After Sales Enquiry</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <!-- TRACE THE NUMBER PLATE AND DISPLAY HIS LAST SERVICE DATE -->
                                                    <input placeholder="dd/mm/yyyy" class="form-control" id="service_date" name="service_date" maxlength="50" value="" data-provider="flatpickr" data-date-format="d/m/Y">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Service Time</label>
                                                    <!-- TRACE THE NUMBER PLATE AND DISPLAY HIS LAST SERVICE TIME -->
                                                    <input type="time" class="form-control" id="service_time" name="service_time" maxlength="50" required value="01:25 PM">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Customer's Phone Number</label>
                                                    <!-- DISPLAY HIS CONTACT NUM USING NUMBER PLATE -->
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <!-- DISPLAY HIS NAME USING NUMBER PLATE -->
                                                    <input type="text" class="form-control" id="customer_name" name="customer_name" maxlength="50" required value="Customer Name">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Car Model</label>
                                                    <!-- DISPLAY HIS CAR MODEL USING NUMBER PLATE -->
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <!-- TRACE THE NUMBER PLATE LAST SERVICE OUTLET -->
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Service</label>
                                                    <!-- TRACE THE NUMBER PLATE LAST SERVICE TYPE -->
    ...
    <script>
        // TO DISABLED DEFAULT FUNCTION OF KEY IN DATE & SERVICE DATE 
        // CHANGE FUNCTION ID IF ID ABOVE IS CHANGED
        $(document).ready(function(){
            document.getElementById('date').readOnly = false;
            document.getElementById('service_date').readOnly = false;
        });
    </script>
