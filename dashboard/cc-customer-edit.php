...
<head>
    <meta charset="utf-8">
    <title>Call Center | Customer Enquiry | Edit Customer Enquiry | <?php echo $base_name; ?></title>
        ...
        <div class="main-content">
             ...
             <section id="bc-section">
                <div id="bc-div">
                    ...
                    <span id="bc-arrow"><i class="ri-arrow-right-s-line"></i></span>
                    <span id="bc-active">Edit Customer Enquiry</span>
                </div>
            </section>
                            ...
                            <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div id="form-box" class="general-box">
                                    <form name="edit_form" method="POST" action="" enctype="multipart/form-data">
                                        <p id="form-sub-title">Edit Customer Enquiry</p>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" class="form-control" id="date" name="date" maxlength="50" value="2023-01-30" data-date-format="DD-YYYY-MM">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Enquiry Time</label>
                                                    <input type="time" class="form-control" id="time" name="time" maxlength="50" value="">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Key In By</label>
                                                    <input type="text" class="form-control" id="s_id" name="s_id" maxlength="50" required value="Chan Mohamad">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    <label>Customer's Phone Number</label>
                                                    <input type="text" class="form-control" id="email" name="email" maxlength="50" required value="011-123456" onkeypress="return validateHP(this, event);">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control js-example-basic-single" id="service_type" name="service_type" required>
                                                        <option disabled>Select Type of Services</option>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control js-example-basic-single" id="category" name="category" required>
                                                        <option disabled>Select Enquiry Category</option>
                                                        <option value="1" selected >Service Enquiry</option>
